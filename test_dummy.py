...
# pytest test_dummy.py::test_sum   to just execete specific function in test ffile
# PyTest cheat sheet
# Installation
...
def test_sum():
    assert dummy.sum(1,2,3)==6
def test_sum1():
    assert dummy.sum(1,2,4)==7
def test_sum2():
    assert dummy.sum(1,2,3)==6.0
def test_sum3():
    assert dummy.sum(1,2,3)==6